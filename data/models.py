...
class IbdData(models.Model):
    ...
    price_change_in_currency = models.FloatField(blank = True, null = True)
    price_change_in_percentage = models.FloatField(blank = True, null = True)
    ...
    ind_grp_rs = models.CharField(max_length=10, blank = True, null = True)
    smr_rating = models.CharField(max_length=10, blank = True, null = True)
    acc_dis_rating = models.CharField(max_length=10, blank = True, null = True)
    spon_rating = models.CharField(max_length=10, blank = True, null = True)
